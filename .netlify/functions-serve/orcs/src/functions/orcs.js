    ...
    function removeMatchingHeaders(regex, headers2) {
      ...
      for (var header in headers2) {
        if (regex.test(header)) {
          lastValue = headers2[header].toString().trim();
  ...
  "node_modules/axios/lib/adapters/http.js"(exports2, module2) {
    ...
    module2.exports = function httpAdapter(config) {
      return new Promise(function dispatchHttpRequest(resolvePromise, rejectPromise) {
        ...
        var headerNames = {};
        Object.keys(headers2).forEach(function storeLowerName(name) {
          headerNames[name.toLowerCase()] = name;
        });
        if ("user-agent" in headerNames) {
          if (!headers2[headerNames["user-agent"]]) {
            delete headers2[headerNames["user-agent"]];
          }
        } else {
          headers2["User-Agent"] = "axios/" + VERSION;
        }
        ...
        if (auth && headerNames.authorization) {
          delete headers2[headerNames.authorization];
        }
  ...
  "node_modules/axios/lib/defaults.js"(exports2, module2) {
    ...
    var defaults = {
      ...
      transformRequest: [function transformRequest(data, headers2) {
        ...
        if (utils.isObject(data) || headers2 && headers2["Content-Type"] === "application/json") {
